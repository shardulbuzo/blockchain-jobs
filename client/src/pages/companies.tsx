...
export default function Companies() {
  const { jobIds, jobsById, categories, locations, companies, loaded, siteName, siteLogo } = useJobsStore();
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title={`Top Crypto Companies Hiring — ${siteName}`}
        description="Discover verified crypto, Web3, blockchain, and fintech companies hiring worldwide. Browse company profiles, open roles, and featured listings."
      ...
      <main id="main-content" className="mx-auto max-w-6xl px-4 py-12">
        <div className="max-w-2xl">
          <h1 className="font-serif text-4xl tracking-tight">Top Crypto Companies</h1>
          <p className="mt-3 text-lg text-muted-foreground">
            Explore leading crypto and blockchain organizations and their latest career opportunities.
          </p>
        </div>

        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {!loaded && (
            <Card className="rounded-2xl border bg-card p-8 text-center sm:col-span-2 lg:col-span-3">
